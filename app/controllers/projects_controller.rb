class ProjectsController < ApplicationController
      ...
      if @project.save
        if params[:images]
          params[:images].each { |image| 
            @project.project_pictures.create(image: image)
          }
        end
  ...
  private
    ...
    def project_params
      params.require(:project).permit(:project_name, :description, :location, :highlighted, :active, :first_video, :second_video, :third_video)
    end
end
